                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="polsekciseeng@gmail.com" value="<?= @$_GET['email'] ?>" required>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="telepon" name="telepon" placeholder="087123456789" value="<?= @$_GET['telepon'] ?>" required>
                                </div>
                                <p class="error"><?= @$_GET['teleponError'] ?></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="alamat" class="col-sm-3 control-label">Alamat Tempat Kejadian Perkara</label>
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="glyphicon glyphicon-home"></span></div>
                                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Tuliskan Alamat Dengan Lengkap" value="<?= @$_GET['alamat'] ?>" required>
                                </div>
                                <p class="error"><?= @$_GET['alamatError'] ?></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tujuan" class="col-sm-3 control-label">Tindak Kejahatan</label>
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="tujuan">
                                        ...
                                        <option value="4">Kejahatan Hukum</option>
                                        <option value="5">Lainnya (harap dijelaskan di isi pengaduan)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
